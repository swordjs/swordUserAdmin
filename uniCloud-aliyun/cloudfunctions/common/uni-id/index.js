...
function E(e, t) {
  ...
  for (const i in e)
    if (p(e, i) && r.test(i)) {
      const r = n(i);
      (e[r] = e[i]), delete e[i], m(e[r]) ? (e[r] = E(e[r], t)) : Array.isArray(e[r]) && (e[r] = e[r].map((e) => E(e, t)));
    }
  return e;
}
...
function j(e = {}, t) {
  ...
  if (m(t))
    for (const i in t) {
      const o = t[i];
      h(o) && -1 === r.indexOf(i) ? (e[i] = o(e)) : 'string' == typeof o && -1 === r.indexOf(i) && ((e[i] = e[o]), n.shouldDelete.add(o));
    }
  else h(t) && (e = t(e));
...
function N(e) {
  if (m(e))
    if (0 === e.code) (e.errCode = e.code), (e.message = e.errMsg = e.msg), delete e.messageValues;
      ...
      const t = R[e.code];
      (e.errCode = 'uni-id-' + t.errCode),
        (e.errDetail = `${e.code}, ${e.msg}`),
        (e.errMsg =
          (function (e, t = {}) {
            const r = R[e];
          ...
          })(e.code, e.messageValues || {}) || e.msg),
        (e.message = e.msg = e.errMsg),
        delete e.messageValues;
...
const M = uniCloud.database(),
  ...
  H = 90004,
  F = 90005;
async function q({ name: e, url: t, data: r, options: n, defaultOptions: i }) {
  let o = {};
  ...
  if (!Buffer.isBuffer(a) || (0 !== c.indexOf('text/plain') && 0 !== c.indexOf('application/json')))
    Buffer.isBuffer(a) &&
      (a = {
        buffer: a,
        contentType: c
...
class W extends class {
  constructor(e = {}) {
    ...
    (this.options.privateKey = this._formatKey(this.options.privateKey, r)),
      this.options.alipayPublicKey && (this.options.alipayPublicKey = this._formatKey(this.options.alipayPublicKey, 'PUBLIC KEY'));
  }
  _formatKey(e, t) {
    return `-----BEGIN ${t}-----\n${e}\n-----END ${t}-----`;
  }
  ...
  async _exec(e, t = {}, r = {}) {
    const n = this._getSign(e, t),
      { url: i, execParams: o } = this._formatUrl(this.options.gateway, n),
      { status: s, data: a } = await uniCloud.httpclient.request(i, {
        method: 'POST',
        data: o,
        dataType: 'text',
        timeout: this.options.timeout
...
var te = ee(function (e, t) {
    ...
    r.from && r.alloc && r.allocUnsafe && r.allocUnsafeSlow ? (e.exports = o) : (n(o, t), (t.Buffer = i)),
...
var ye = {
    derToJose: function (e, t) {
      ...
      return e.copy(p, o, d + Math.max(-l, 0), d + u), (p = (p = p.toString('base64')).replace(/=/g, '').replace(/\+/g, '-').replace(/\//g, '_'));
    },
    joseToDer: function (e, t) {
      ...
      return (
        (d[f++] = 48),
        u ? (d[f++] = c) : ((d[f++] = 129), (d[f++] = 255 & c)),
        (d[f++] = 2),
        (d[f++] = s),
        i < 0 ? ((d[f++] = 0), (f += e.copy(d, f, 0, r))) : (f += e.copy(d, f, i, r)),
        (d[f++] = 2),
        (d[f++] = a),
        o < 0 ? ((d[f++] = 0), e.copy(d, f, r)) : e.copy(d, f, r + o),
        d
      );
    }
  },
...
function Te(e) {
  if (!we.isBuffer(e) && 'string' != typeof e && 'object' != typeof e) throw Ie('key must be a string, a buffer or an object');
}
...
function et(e) {
  ...
  (this.readable = !0),
    ...
    (this.signature = new ie(e.signature)),
    this.secret.once(
      'close',
      function () {
...
var gt = function (e, t) {
  ...
  yt = ee(function (e, t) {
    ...
    function oe(e, t) {
      if (
        ...
        return e.loose === !!t.loose && e.includePrerelease === !!t.includePrerelease ? e : new oe(e.raw, t);
    ...
    function ae(e, t, r, n, i, o, s, a, c, u, d, f, l) {
      return (
        (t = se(r) ? '' : se(n) ? '>=' + r + '.0.0' : se(i) ? '>=' + r + '.' + n + '.0' : '>=' + t) +
        ' ' +
        (a = se(c) ? '' : se(u) ? '<' + (+c + 1) + '.0.0' : se(d) ? '<' + c + '.' + (+u + 1) + '.0' : f ? '<=' + c + '.' + u + '.' + d + '-' + f : '<=' + a)
      ).trim();
    }
      ...
      for (var u = 0; u < t.set.length; ++u) {
        ...
        if (
          (d.forEach(function (e) {
            e.semver === ie && (e = new ne('>=0.0.0')), (f = f || e), (l = l || e), i(e.semver, f.semver, n) ? (f = e) : s(e.semver, l.semver, n) && (l = e);
          }),
    ...
    (ne.prototype.parse = function (e) {
      ...
      (this.operator = r[1]), '=' === this.operator && (this.operator = ''), r[2] ? (this.semver = new G(r[2], this.options.loose)) : (this.semver = ie);
    }),
      ...
      (ne.prototype.test = function (e) {
        return (
          ...
          this.semver === ie || ('string' == typeof e && (e = new G(e, this.options)), re(e, this.operator, this.semver, this.options))
        );
      }),
      (ne.prototype.intersects = function (e, t) {
        ...
        if (
          ...
          return (r = new oe(e.value, t)), ue(this.value, r, t);
      ...
      (oe.prototype.parseRange = function (e) {
        ...
        (e = e.replace(n, ae)),
          ...
          (e = (e = (e = e.replace(i[O], '$1~')).replace(i[N], '$1^')).split(/\s+/).join(' '));
        var o = t ? i[L] : i[U],
          s = e
            .split(' ')
            .map(function (e) {
                          ...
                          return e.replace(n, function (t, n, i, o, s) {
                            ...
                            return (
                              ...
                              se(n)
                                ...
                                ? (a = '>=' + n + '.0.0 <' + (+n + 1) + '.0.0')
                                : se(o)
                                ? (a = '0' === n ? '>=' + n + '.' + i + '.0 <' + n + '.' + (+i + 1) + '.0' : '>=' + n + '.' + i + '.0 <' + (+n + 1) + '.0.0')
                                : s
                                ? (r('replaceCaret pr', s),
                                  (a =
                                    '0' === n
                          ...
                          return e.replace(n, function (t, n, i, o, s) {
                            ...
                            return (
                              ...
                              se(n)
                                ...
                                ? (a = '>=' + n + '.' + i + '.0 <' + n + '.' + (+i + 1) + '.0')
                                : s
                                ? (r('replaceTilde pr', s), (a = '>=' + n + '.' + i + '.' + o + '-' + s + ' <' + n + '.' + (+i + 1) + '.0'))
                                : (a = '>=' + n + '.' + i + '.' + o + ' <' + n + '.' + (+i + 1) + '.0'),
                              r('tilde return', a),
                              a
                            );
  ...
  wt =
    ...
    yt.inc,
    yt.diff,
    yt.compareIdentifiers,
    yt.rcompareIdentifiers,
    yt.major,
    yt.minor,
    yt.patch,
    yt.compare,
    ...
    yt.intersects,
    yt.coerce,
    yt.satisfies(process.version, '^6.12.0 || >=8.0.0')),
  ...
  var r =
      ...
      (function (e) {
        return (
          ...
          Pt.call(e, 'callee') &&
          (!Nt.call(e, 'callee') || '[object Arguments]' == Dt.call(e))
        );
      })(e)
        ? (function (e, t) {
...
function Bt(e, t) {
  return !!(t = null == t ? 9007199254740991 : t) && ('number' == typeof e || It.test(e)) && e > -1 && e % 1 == 0 && e < t;
}
var $t = Array.isArray;
...
var Ar = {
  ...
  Rr = function (e, t, r, n) {
    ...
    if (
      ...
      return i(new ot('clockTimestamp must be a number'));
    if (void 0 !== r.nonce && ('string' != typeof r.nonce || '' === r.nonce.trim())) return i(new ot('nonce must be a non-empty string'));
    ...
    if ('function' == typeof t) {
      if (!n) return i(new ot('verify must be called asynchronous if secret or public key is provided as a callback'));
      c = t;
    } else
      c = function (e, r) {
        return r(null, t);
    ...
    return c(u, function (t, n) {
      ...
      if (
        ...
        r.algorithms ||
          (r.algorithms =
            ~n.toString().indexOf('BEGIN CERTIFICATE') || ~n.toString().indexOf('BEGIN PUBLIC KEY')
              ? vt
              : ~n.toString().indexOf('BEGIN RSA PUBLIC KEY')
              ? _t
              : bt),
        !~r.algorithms.indexOf(s.header.alg))
      )
        return i(new ot('invalid algorithm'));
      try {
      ...
      if (void 0 !== f.nbf && !r.ignoreNotBefore) {
        ...
        if (f.nbf > o + (r.clockTolerance || 0)) return i(new at('jwt not active', new Date(1e3 * f.nbf)));
      }
      if (void 0 !== f.exp && !r.ignoreExpiration) {
        if ('number' != typeof f.exp) return i(new ot('invalid exp value'));
        if (o >= f.exp + (r.clockTolerance || 0)) return i(new ut('jwt expired', new Date(1e3 * f.exp)));
      }
      if (r.audience) {
        var l = Array.isArray(r.audience) ? r.audience : [r.audience];
        if (
          !(Array.isArray(f.aud) ? f.aud : [f.aud]).some(function (e) {
      ...
      if (r.issuer && (('string' == typeof r.issuer && f.iss !== r.issuer) || (Array.isArray(r.issuer) && -1 === r.issuer.indexOf(f.iss))))
        return i(new ot('jwt issuer invalid. expected: ' + r.issuer));
      if (r.subject && f.sub !== r.subject) return i(new ot('jwt subject invalid. expected: ' + r.subject));
      ...
      if (r.maxAge) {
        ...
        if (void 0 === p) return i(new ot('"maxAge" should be a number of seconds or string representing a timespan eg: "1d", "20h", 60'));
...
class Pr {
  ...
  async getAuthKeys() {
    const { status: e, data: t } = await this._fetch('/auth/keys', {
      method: 'GET',
      dataType: 'json',
      timeout: this.options.timeout
    });
...
var Zr = Object.freeze({
  ...
  resetPwd: async function ({ uid: e, password: t }) {
    const { passwordHash: r, version: n } = this.encryptPwd(t),
      i = {
        password: r,
        token: []
      };
    return (
      ...
      I('upRes', await V.doc(e).update(i)),
      {
        code: 0,
        msg: '密码重置成功'
      }
  ...
  updatePwd: async function (e) {
    ...
    if (t && t.data && t.data.length > 0) {
      if (0 === this._checkPwd(t.data[0], e.oldPassword).code) {
        const { passwordHash: r, version: n } = this.encryptPwd(e.newPassword),
          i = {
            password: r,
            token: []
          };
        n && (i.password_secret_version = n);
        return (
          I('upRes', await V.doc(t.data[0]._id).update(i)),
          {
            code: 0,
            msg: '修改成功'
          }
  ...
  updateUser: async function (e) {
    ...
    delete e.uid;
    const { username: r, email: n } = e,
      { usernameToLowerCase: i, emailToLowerCase: o } = this._getConfig();
    let s = r && r.trim(),
      a = n && n.trim();
    return (
      s && (i && (s = s.toLowerCase()), (e.username = s)),
      a && (o && (a = a.toLowerCase()), (e.email = a)),
      I('update -> upRes', await V.doc(t).update(e)),
      {
        code: 0,
        msg: '修改成功'
      }
  ...
  _getAlipayApi: function ({ platform: e } = {}) {
    const t = e || this.context.PLATFORM;
    if (!t) throw new Error('未能获取客户端平台信息，请主动传入platform');
    const r = this._getConfig(t);
    if (!r.oauth || !r.oauth.alipay) throw new Error(`请在公用模块uni-id的config.json或init方法中添加${t}平台支付宝登录配置项`);
    return (
      ['appid', 'privateKey'].forEach((e) => {
        if (!r.oauth.alipay[e]) throw new Error(`请在公用模块uni-id的config.json或init方法中添加配置项：${t}.oauth.alipay.${e}`);
      }),
      Nr({
        ...r.oauth.alipay,
        clientType: t
  ...
  _getValidInviteCode: async function ({ inviteCode: e }) {
    let t,
      r = 10;
    e ? ((r = 1), (t = e)) : (t = Vr());
    let n = !1;
  ...
  _addUser: async function (e, t = {}) {
    ...
    if (r.removePermissionAndRoleFromToken) {
      ...
      const t = e.role || [];
      let r;
      (r = 0 === t.length || t.includes('admin') ? [] : await this._getPermissionListByRoleList(t)),
        (o = await this.createToken({
          uid: i,
          role: t,
          permission: r
    ...
    const { token: s, tokenExpired: a } = o;
    return (
      await V.doc(i).update({
        token: [s]
      }),
      {
        token: s,
  ...
  _getWeixinApi: function ({ platform: e } = {}) {
    const t = e || this.context.PLATFORM;
    if (!t) throw new Error('未能获取客户端平台信息，请主动传入platform');
    const r = this._getConfig(t);
    ...
    return (
      ['appid', 'appsecret'].forEach((e) => {
        if (!r.oauth.weixin[e]) throw new Error(`请在公用模块uni-id的config.json或init方法中添加配置项：${t}.oauth.weixin.${e}`);
      }),
      Dr({
        ...r.oauth.weixin,
        clientType: t
  ...
  _getMatchedUser: function (e, t) {
    ...
    for (let r = e.length - 1; r >= 0; r--) {
      ...
      for (let s = 0; s < t.length; s++) {
        const { field: a, value: c, fallbackValue: u } = t[s];
        c && o[a] === c ? ((n[a] = o), e.splice(r, 1)) : u && o[a] === u && (n[a] || (n[a] = o), (i[a] = !0), e.splice(r, 1));
      }
    }
  ...
  acceptInvite: async function ({ uid: e, inviteCode: t }) {
    ...
    if (i.data[0].inviter_uid && i.data[0].inviter_uid.length > 0)
      return {
        code: 80503,
        msg: '邀请码不可修改'
      };
  ...
  loginByAlipay: async function (e) {
    ...
    const r = t.needPermission,
      ...
      { openid: i } = await this._getAlipayApi({
        platform: n
      }).code2Session(t.code);
    if (!i)
      return {
  ...
  loginByEmail: async function ({ email: e, code: t, password: r, myInviteCode: n, type: i, needPermission: o, role: s }) {
    if (!(e = e && e.trim()))
      return {
        code: $,
        messageValues: {
    ...
    const { emailToLowerCase: a } = this._getConfig();
    let c = e;
    a && (c = e.toLowerCase());
  ...
  loginBySms: async function ({ mobile: e, code: t, password: r, inviteCode: n, myInviteCode: i, type: o, needPermission: s, role: a }) {
    if (!(e = e && e.trim()))
      return {
        code: $,
        messageValues: {
    ...
    }
    {
      ...
      const u = {
        ...
        d = r && r.trim();
      if (d) {
        const { passwordHash: e, version: t } = this.encryptPwd(d);
  ...
  loginByUniverify: async function ({ openid: e, access_token: t, password: r, inviteCode: n, myInviteCode: i, type: o, needPermission: s, role: a }) {
    const c = this._getConfig(),
    ...
    const p = Date.now(),
      ...
      h = r && r.trim();
    if (h) {
      const { passwordHash: e, version: t } = this.encryptPwd(h);
  ...
  loginByApple: async function ({ nickName: e, fullName: t, identityToken: r, myInviteCode: n, type: i, needPermission: o, platform: s, role: a }) {
    const c = this._getConfig(),
    ...
    const { iss: m, sub: h, aud: g, email: y } = p;
    if ('https://appleid.apple.com' !== m)
      return {
        code: 10706,
        msg: '签发机构检验失败',
        messageValues: {
  ...
  login: async function ({ username: e, password: t, queryField: r = [], needPermission: n }) {
    ...
    const { usernameToLowerCase: s, emailToLowerCase: a, passwordErrorLimit: c, passwordErrorRetryTime: u } = this._getConfig(),
      d = {
        email: {
          email_confirmed: 1
        },
    ...
    r.forEach((t) => {
      ...
      'username' === t && f.username !== e
        ? (o.push({
            [t]: f.username,
            ...d[t]
          }),
          (r.fallbackValue = f.username))
        : 'email' === t &&
          f.email !== e &&
          (o.push({
            [t]: f.email,
    ...
    if (0 === b.code) {
      ...
      const t = {
        ...
        { passwordHash: r, passwordVersion: i } = b;
    ...
    return (
      v
        ? (v.error_times++, (v.last_error_time = Date.now()))
        : ((v = {
            ip: h,
            error_times: 1,
  ...
  register: async function (e) {
    const t = [],
      ...
      { usernameToLowerCase: n, emailToLowerCase: i } = this._getConfig(),
      o = e.needPermission;
    if (
      (void 0 !== o && delete e.needPermission,
      r.forEach((r) => {
        const o = r.name;
        let s = e[o] && e[o].trim();
        s
          ? ((('username' === r.name && n) || ('email' === r.name && i)) && (s = s.toLowerCase()),
            (e[o] = s),
            t.push({
              [o]: s,
              ...r.extraCond
    ...
    const { username: s, email: a, mobile: c, myInviteCode: u } = e,
      d = Hr.command,
      f = await V.where(d.or(...t)).get();
    if (f && f.data.length > 0) {
      const t = f.data[0];
      for (let n = 0; n < r.length; n++) {
        const i = r[n];
        let o = !0;
        if ((i.extraCond && (o = Object.keys(i.extraCond).every((e) => t[e] === i.extraCond[e])), t[i.name] === e[i.name] && o))
          return {
            code: 20102,
            messageValues: {
              type: i.desc
    ...
    const { passwordHash: p, version: m } = this.encryptPwd(l);
  ...
  bindRole: async function ({ uid: e, roleList: t, reset: r = !1 }) {
    ...
    return (
      'string' == typeof t && (t = [t]),
      (n.role = r ? t : qr.push(t)),
      await V.doc(e).update(n),
      {
        code: 0,
        msg: '角色绑定成功'
      }
  ...
  bindEmail: async function ({ uid: e, email: t, code: r }) {
    ...
    const { emailToLowerCase: n } = this._getConfig();
    n && (t = t.toLowerCase());
  ...
  bindMobile: async function ({ uid: e, mobile: t, code: r, openid: n, access_token: i, type: o = 'sms' }) {
    if ('univerify' === o) {
  ...
  verifyAppleIdentityToken: async function ({ identityToken: e, platform: t }) {
    const r = t || this.context.PLATFORM,
      { code: n, msg: i } = await Mr({
        clientType: r
  ...
  wxBizDataCrypt: async function ({ code: e, sessionKey: t, encryptedData: r, iv: i }) {
    if (!r)
      return {
        code: 80805,
        messageValues: {
  ...
  encryptPwd: function (e, { value: t, version: r } = {}) {
  ...
  checkToken: async function (e, { needPermission: t, needUserInfo: r = !0 } = {}) {
    const n = this._getConfig();
    try {
      const i = this._verifyToken(e);
      if (i.code) return i;
      const { uid: o, needPermission: s, role: a, permission: c, exp: u } = i,
        d = a && c;
      t = void 0 === t ? s : t;
      const f = n.removePermissionAndRoleFromToken || !d || r,
        l =
          (!n.removePermissionAndRoleFromToken && !d) ||
          (n.removePermissionAndRoleFromToken && d) ||
          (n.tokenExpiresThreshold && u - Date.now() / 1e3 < n.tokenExpiresThreshold);
      let p = {};
      if (f || l) {
        const t = await V.doc(o).get();
        if (!t.data || 0 === t.data.length || !t.data[0].token)
          return {
            code: 30202,
            msg: 'token不合法，请重新登录'
          };
        if (((p = t.data[0]), 1 === p.status))
          return {
            code: 10001,
            msg: '账号已禁用'
          };
        let r = p.token;
        if ((r ? 'string' == typeof r && (r = [r]) : (r = []), -1 === r.indexOf(e)))
          return {
            code: 30202,
            msg: 'token不合法，请重新登录'
          };
      ...
      let h, g;
      if (
        (d && ((m.role = a), (m.permission = c)),
        r && (m.userInfo = p),
        ((!d && t) || l) &&
          ((h = m.role = p.role || []),
          (g = 0 === h.length || h.includes('admin') ? (m.permission = []) : (m.permission = await this._getPermissionListByRoleList(m.role))),
          t && ((m.role = h), (m.permission = g))),
        l)
      ) {
        let e;
        e = n.removePermissionAndRoleFromToken
        ...
        return (
          (t = t.filter((e) => -1 === r.indexOf(e))),
          t.push(e.token),
          await V.doc(o).update({
            token: t,
            last_login_date: Date.now(),
            last_login_ip: this.context.CLIENTIP
          }),
  ...
  createToken: function ({ uid: e, needPermission: t, role: r, permission: n }) {
    if (!e)
      return {
        code: 30101,
        messageValues: {
  ...
  _checkPwd: function (e, t) {
    ...
    const { password: r, password_secret_version: n } = e,
      i = this._getConfig(),
      { passwordSecret: o } = i,
      s = y(o);
    if ('string' === s) {
      const { passwordHash: e } = this.encryptPwd(t, {
        value: o
      });
      return e === r
        ? {
    ...
    let c;
    if (((c = n ? a.find((e) => e.version === n) : a[0]), !c))
      return {
        code: 3,
        message: 'secretVersion不正确'
      };
    const u = a[a.length - 1],
      { passwordHash: d } = this.encryptPwd(t, c);
    if (d === r) {
      const e = {
        code: 0,
        message: '密码校验通过'
      ...
      if (c !== u) {
        const { passwordHash: r, version: n } = this.encryptPwd(t, u);
  ...
  _getClientUaHash: function () {
    const e = n.createHash('md5'),
      t = /MicroMessenger/i.test(this.context.CLIENTUA) ? this.context.CLIENTUA.replace(/(MicroMessenger\S+).*/i, '$1') : this.context.CLIENTUA;
    return e.update(t), e.digest('hex');
  },
  _createTokenInternal: function ({ signContent: e, config: t }) {
    return 'object' === y(e) && e.uid
  ...
  setVerifyCode: async function ({ mobile: e, email: t, code: r, expiresIn: n, type: i }) {
    if (((t = t && t.trim()), (e = e && e.trim()), t)) {
      const { emailToLowerCase: e } = this._getConfig();
      e && (t = t.toLowerCase());
    }
    if (!e && !t)
      return {
  ...
  verifyCode: async function ({ mobile: e, email: t, code: r, type: n }) {
    if (((t = t && t.trim()), (e = e && e.trim()), t)) {
      const { emailToLowerCase: e } = this._getConfig();
      e && (t = t.toLowerCase());
    }
  ...
  sendSmsCode: async function ({ mobile: e, code: t, type: r, templateId: n }) {
    ...
    const { name: a, smsKey: c, smsSecret: u, codeExpiresIn: d } = o;
    let f;
    switch (r) {
      case 'login':
        f = '登录';
...
class rn {
  constructor({ context: e, config: t } = {}) {
    const r =
      en &&
      en({
        pluginId: 'uni-id'
    ...
    (this.pluginConfig = r),
      (this.config = t || this._getConfigContent()),
      Object.defineProperty(this, 'context', {
        get: () => e || global.__ctx__
      }),
      (this.interceptorMap = new Map()),
      r && r.hasFile('custom-token.js') && this.setInterceptor('customToken', require(r.resolve('custom-token.js')));
  }
  _getConfigContent() {
  ...
  _getConfig(e) {
    ...
    return (
      ['passwordSecret', 'tokenSecret', 'tokenExpiresIn', 'passwordErrorLimit', 'passwordErrorRetryTime'].forEach((e) => {
...
function on({ context: e, config: t } = {}) {
  const r = new rn({
    context: e,
    config: t
  });
    ...
    get(e, t) {
      if (t in e && 0 !== t.indexOf('_'))
        return 'function' == typeof e[t]
          ? (nn.indexOf(t) > -1 && console.warn(`uniID.${t}方法即将废弃，后续版本将不再暴露此方法`),
            ((r = e[t]),
            function () {
