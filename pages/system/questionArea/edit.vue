<template>
	<view class="container">
		...
		<view class="uni-container">
			<unicloud-db ref="udb" v-slot:default="{data, loading, error, options}" collection="questionArea"
				field="name,iconPath" :getone="true" :where="`_id=='${formData.id}'`" :manual="true">
