        ...
        <view class="uni-tabs__nav-scroll">
          <view class="uni-tabs__nav">
            <view
              ...
              :class="{ 'is-active': currentTab === 'menus' }"
              class="uni-tabs__item"
            >
              菜单管理
            </view>
            <view
              @click="switchTab('pluginMenus')"
              v-if="pluginMenus.length"
              :class="{ 'is-active': currentTab === 'pluginMenus' }"
              class="uni-tabs__item"
            >
              待添加菜单
              <uni-badge
                class="menu-badge"
                :text="pluginMenus.length"
                type="error"
              ></uni-badge>
            </view>
          </view>
          ...
          <uni-tr v-for="(item, index) in menus" :key="index">
            ...
            <uni-td align="center">
              <view class="uni-group">
                <button
                  v-if="!item.url"
                  @click="navigateTo('./add?parent_id=' + item.menu_id, false)"
                  class="uni-button"
                  size="mini"
                  type="primary"
                >
