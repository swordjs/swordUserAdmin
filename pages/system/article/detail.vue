	...
	<view class="container">
		...
		<view class="uni-container">
			<unicloud-db ref="udb" v-slot:default="{data, loading, error, options}"
				collection="article,questionTag,uni-id-users" field="title,content,tagID{name}" :getone="true"
				:where="`_id=='${id}'`" :manual="true">
				<uni-forms ref="form" :value="formData" :rules="rules" validate-trigger="submit">
					...
					<uni-forms-item v-if="state === 'reject'" style="width: 60vw;" labelWid="100" name="reason"
						label="拒绝原因" required>
					...
					<view class="uni-button-group">
						<button style="width: 100px;" type="primary" class="uni-button"
							@click="submitAudit">确定审核</button>
						<button style="width: 100px;margin-left: 15px;" type="primary" class="uni-button"
							@click="submitForm">修改信息</button>
